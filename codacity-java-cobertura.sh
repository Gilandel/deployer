...
mkdir lib
mvn org.apache.maven.plugins:maven-dependency-plugin:3.0.0:copy-dependencies -f /path/to/m2/repo/com/codacy/codacy-coverage-reporter/$VERSION/codacy-coverage-reporter-$VERSION.pom -DoutputDirectory=./lib
